 ...
 * useAdmin route that will check whether the user is admin or not. If not admin
 * then redirect to any other page. you could logout user and send them to the 
 * login page as well.
 * 
 * -----------------------
 *     TO SEND DATA
 ...
 * 2. if it is an admin activity. Make sure only admin user is posting data by using
 * verifyAdmin
 * 3.  
 * 
 * **/ 